...
extern const MIDL_SERVER_INFO IArpScanner_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IArpScanner_ProxyInfo;
...
/* 544 */	0x8,		/* FC_LONG */
	...
	/* Procedure get_ScannedHostCount */
...
/* Object interface: IArpScanner, ver. 0.0,
   GUID={0x12F0C3AF,0x5936,0x4601,{0xA8,0x10,0xF0,0x32,0x6F,0x80,0x59,0x52}} */

#pragma code_seg(".orpc")
static const unsigned short IArpScanner_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IArpScanner_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IArpScanner_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IArpScanner_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(22) _IArpScannerProxyVtbl = 
{
    &IArpScanner_ProxyInfo,
    &IID_IArpScanner,
    ...
    (void *) (INT_PTR) -1 /* IArpScanner::get_StartIP */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::put_StartIP */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::get_EndIP */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::put_EndIP */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::put_Key */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::get_Adapter */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::put_Adapter */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::get_HostCount */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::StartScan */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::get_AdapterCount */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::GetAdapterInfo */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::Scan */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::StopScan */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::LookupAdapterName */ ,
    (void *) (INT_PTR) -1 /* IArpScanner::get_ScannedHostCount */
};


static const PRPC_STUB_FUNCTION IArpScanner_table[] =
{
...
CInterfaceStubVtbl _IArpScannerStubVtbl =
{
    &IID_IArpScanner,
    &IArpScanner_ServerInfo,
    22,
    &IArpScanner_table[-3],
...
const CInterfaceProxyVtbl * __ArpSweep_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IArpScannerProxyVtbl,
    0
};

const CInterfaceStubVtbl * __ArpSweep_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IArpScannerStubVtbl,
    0
};

PCInterfaceName const __ArpSweep_InterfaceNamesList[] = 
{
    "IArpScanner",
    0
};

const IID *  __ArpSweep_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define __ArpSweep_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __ArpSweep, pIID, n)

int __stdcall __ArpSweep_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!__ArpSweep_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo _ArpSweep_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __ArpSweep_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __ArpSweep_StubVtblList,
    (const PCInterfaceName * ) & __ArpSweep_InterfaceNamesList,
    (const IID ** ) & __ArpSweep_BaseIIDList,
    & __ArpSweep_IID_Lookup, 
    1,
    2,
